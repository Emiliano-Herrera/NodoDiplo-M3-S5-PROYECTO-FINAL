document.getElementById('boton-cargar-api').addEventListener('click', async (e) => {
    ...
    const cargarBoton = document.querySelector('.boton-cargar-api');
    cargarBoton.disabled = true;
    cargarBoton.textContent = 'Cargando...';
    ...
    try {
            ...
            if (response.ok) {
                ...
                cargarBoton.disabled = false;
                cargarBoton.textContent = 'Cargar API';
