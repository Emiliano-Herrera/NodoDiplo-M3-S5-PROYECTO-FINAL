        ...
        try {
            ...
            if (response.ok) {
                ...
                await Swal.fire({
                    icon: 'success',
                    title: '¡Pais editado!',
                    text: 'El pais fue actualizado exitosamente.',
                ...
                await Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: data.mensaje || 'Error al editar el pais'
                });

                enviarBoton.disabled = false;
                enviarBoton.textContent = 'Editar Pais';
...
// Agregar un  por defecto al cargar
